...
#
#   --table  additionally print the extracted Amsterdam column, for a report.
#            It is inventory, not a check: this build implements no Amsterdam
#            rules, so there is nothing to compare it against.
#
